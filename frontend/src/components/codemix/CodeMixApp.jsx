      ...
      {apiStatus === 'offline' && (
        <div className="bg-rose-50 border border-rose-200 p-6 rounded-xl flex items-start shadow-sm">
          ...
          <div>
            ...
            <p className="text-rose-600 mb-2 font-medium">The NLP models failed to load. Please ensure paths in <code>models.py</code> are correct and models are downloaded.</p>
          </div>
        </div>
      )}
