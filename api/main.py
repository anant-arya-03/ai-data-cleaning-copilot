...
from models import load_models, smart_predict, predict_batch, predict_misinfo, predict_fakenews, predict_emosen, predict_all, analyse_text
...
def nlp_predict(model_type: str, req: NlpRequest):
    if app.state.nlp_models is None:
        ...
        try:
            ...
            raise HTTPException(status_code=503, detail=f"NLP models failed to load: {e}")
